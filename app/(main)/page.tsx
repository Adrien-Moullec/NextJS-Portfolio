  ...
  return (
    <>
      <div id="First section" className={"text-white flex-1 flex flex-col place-items-center text-4xl pt-5"}>
        ...
        <div>
          <img className="mx-auto w-3/9" alt="profile" src={basePath + "/Pictures/profile.webp"} width={50} height={50} />
        </div>
        <div id="ABOUT ME" className="flex items-center p-5 pt-10 space-y-5 flex-col min-w-2/5 max-w-2/5">
