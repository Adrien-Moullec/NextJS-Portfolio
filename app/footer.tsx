...
const basePath = process.env.NODE_ENV === 'production'
  ? '/NextJS-Portfolio'
  : '';
import { ProjectCardLayout } from "@/components/InformationLayout/ProjectPage";
...
export const Footer = () => {
  return (
    <footer className="row-start-3 flex gap-[24px] flex-wrap items-center justify-center bg-indigo-950">
      <Carousel opts={{
        align: "start",
        loop: true,
      }}>
